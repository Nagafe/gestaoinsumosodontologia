...
![Der Conceitual - SGICO.png](<principal/static/images/Der Conceitual - SGICO.png>)
...
![Diagrama de Classe (SGICO).png](<principal/static/images/Diagrama de Classe (SGICO).png>)
